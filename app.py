...
# ------------------------------------------------
# Load precomputed embeddings & FAISS index
# ------------------------------------------------
embeddings = np.load(os.path.join(ARTIFACTS_PATH, "embeddings.npy"))
faiss_index = faiss.read_index(
    os.path.join(ARTIFACTS_PATH, "faiss.index")
)
...
def recommend():
    ...
    return jsonify({
        "matched_title": movies.iloc[indices[norm]]["title"],
...
# ------------------------------------------------
# Run (Render / Gunicorn ignores this)
# ------------------------------------------------
